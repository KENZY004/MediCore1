...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Prepare data heavily based on backend expectation
            // The backend expects: name, email, password, phone, address (object), regressionNumber, etc.
            // Admin contact is part of hospital model, not separate admin user
        ...
        <div className="auth-container">
            <div className="auth-card auth-card-wide">
                <div className="auth-header">
                    ...
                    <p>Register your hospital on ZenoCare Platform</p>
                </div>
